pipeline {
    ...
    stages { 
     ...
     stage('deploying') {
            steps {
             sh 'sudo mv /home/jenkins-slave1/workspace/hello_world/target/hello-world-war-1.0.0.war /home/jenkins-slave1/workspace/hello_world/target/hello-world-war-1.0.0.jenkins_job.war'
